                    ...
                    <div className="lg:col-span-5 flex flex-col space-y-10">
                        ...
                        <div className="flex items-center gap-6 group cursor-default">
                            ...
                            <div className="flex flex-col space-y-1">
                                <span className="text-3xl font-bold tracking-widest text-white leading-none">{t('footer.title')}</span>
                    ...
                    <div className="lg:col-span-7 grid grid-cols-2 md:flex md:flex-row justify-between lg:pl-20 pt-4 gap-12">
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="flex flex-wrap gap-4">
                                ...
                                {/* Discord */}
                                <a href="#" className="group w-16 h-16 bg-white/[0.02] border border-white/5 rounded-2xl flex items-center justify-center hover:bg-white/[0.05] hover:border-indigo-500/50 hover:shadow-[0_0_30px_rgba(99,102,241,0.15)] transition-all duration-500 relative overflow-hidden">
                                    ...
                                    <svg className="w-6 h-6 text-slate-400 group-hover:text-indigo-400 group-hover:scale-110 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                {/* X (Twitter) */}
                                <a href="#" className="group w-16 h-16 bg-white/[0.02] border border-white/5 rounded-2xl flex items-center justify-center hover:bg-white/[0.05] hover:border-slate-300/50 hover:shadow-[0_0_30px_rgba(255,255,255,0.1)] transition-all duration-500 relative overflow-hidden">
                                    <div className="absolute inset-0 bg-gradient-to-tr from-white/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                                    <svg className="w-5 h-5 text-slate-400 group-hover:text-white group-hover:scale-110 transition-all duration-300" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
